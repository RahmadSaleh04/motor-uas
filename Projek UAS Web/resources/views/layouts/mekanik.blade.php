    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ url('/mekanik') }}" class="nav-item nav-link {{ Request::is('mekanik') ? 'active text-info' : '' }}">Home</a>
            </div>
            ...
            @endauth
            <a href="{{ url('/mekanik') }}" class="btn btn-dark py-4 px-lg-5 d-none d-lg-block">Mekanik<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
